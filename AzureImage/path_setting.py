...
BASE_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'AzureImg/')
...
OUTPUT_IMAGE_DIR = os.path.join(BASE_DIR, "faceImg/")
IMAGE_PATH_PATTERN = os.path.join(BASE_DIR, "jin7/*")
# Test Image Directory
TEST_IMAGE_PATH = os.path.join(BASE_DIR, "test_image")
# Face Image Directory
SCRATCHIMAGE_PATH_PATTERN = OUTPUT_IMAGE_DIR + "/*"
# Output Directory
SCRATCHIOUTPUT_IMAGE_DIR = os.path.join(BASE_DIR, "face_scratch_image")
